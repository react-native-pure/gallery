...
import {ICenterOn, ZoomViewProps, SwipeDirectionType} from './types';
...
// 是否在左右滑
    ...
    imagePanResponder = createResponder({
    ...
    /*
        imagePanResponder = createResponder({
            ...
            onResponderMove: (evt, gestureState) => {
                ...
                //this.props.horizontalOuterRangeOffset(gestureState.dx);
                return
                ...
                if (evt.nativeEvent.changedTouches.length <= 1) {
                    ...
                    if (this.props.panToMove) {
                        ...
                        if (this.swipeDownOffset === 0) {
                            ...
                            console.log("this.horizontalWholeOuterCounter ==== ",this.horizontalWholeOuterCounter)
                            // 溢出量不会超过设定界限
            ...
            onResponderRelease: (evt, gestureState) => {
                console.log("end=====")
                this.props.onResponderRelease(evt, gestureState)
    ...
    */
    ...
    panResponderReleaseResolve = () => {
        ...
        //     }
        // }
        if (this.props.enableSwipeDown && this.horizontalWholeOuterCounter !== 0) {
            if (this.props.onSwipeDown) {
                this.props.onSwipeDown(this.horizontalWholeOuterCounter > 0 ? SwipeDirectionType.right : (this.horizontalWholeOuterCounter < 0 ? SwipeDirectionType.left : SwipeDirectionType.none))
            }
        }
